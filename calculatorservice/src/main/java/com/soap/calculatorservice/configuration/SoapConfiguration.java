package com.soap.calculatorservice.configuration;
...
public class SoapConfiguration extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema calculatorSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.soap.calculator.org/calculator_schema");
    ...
    public XsdSchema countriesSchema() {
        return new SimpleXsdSchema(new ClassPathResource("CalculatorSchema.xsd"));
    }
}
